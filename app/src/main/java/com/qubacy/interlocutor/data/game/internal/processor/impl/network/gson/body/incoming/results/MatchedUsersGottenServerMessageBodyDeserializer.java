...
public class MatchedUsersGottenServerMessageBodyDeserializer
    extends MessageBodyDeserializer<MatchedUsersGottenServerMessageBody>
{

    @Override
    public MatchedUsersGottenServerMessageBody deserialize(
